...
#    ctx.curve_to((firstx+secondx)/1.5, (firsty+secondy)/1.5, (firstx+secondx)/1.5, (firsty+secondy)/1.5, secondx, secondy)
#    ctx.curve_to((secondx+thirdx)/1.5, (secondy+thirdy)/1.5, (secondx+thirdx)/1.5, (secondy+thirdy)/1.5, thirdx, thirdy)
#    ctx.curve_to((thirdx+forthx)/1.5, (thirdy+forthy)/1.5, (thirdx+forthx)/1.5, (thirdy+forthy)/1.5, forthx, forthy)
...
def fit(geno, arch):
    ...
    angles = abs(geno[0] - geno[4]) + abs(geno[1] - geno[5]) + abs(geno[2] - geno[6]) + abs(geno[3] - geno[7])
    radius = abs(r1 - r5) + abs(r2 - r6) + abs(r3 - r7)  + abs(r4 - r8)
    #f = -(x + y)
    f = - (radius + angles) / (2*3.6)
